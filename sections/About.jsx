...
<TypingText title='| About The Metaverse' textStyles='text-center' /> 
    ...
    className='mt-[80px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white'>
      What is <span className='font-extrabold text-white'>The Metaverse</span>?  Well this is no longer a thing of the <span className='font-extrabold text-white'> future</span>, where you are able to enjoy the virtual world 
